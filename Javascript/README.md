...
### Adding tooltip to chart bars with appending title
...
svg
  ...
  .attr('fill', 'navy')
  .attr('class', 'bar')
  .append('title') // For adding tooltip we append title attribute
  .text((d) => d); // Then change tooltip text based on given data
